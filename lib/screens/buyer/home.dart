...
class _ProductSliderState extends State<ProductSlider> {
  ...
  void initState() {
    super.initState();
    _productsFuture = fetchProductsByType(widget.prType);
  }
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Error loading ${widget.prType}', style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 15)),
                const SizedBox(height: 8.0),
                Text('${snapshot.error}', style: const TextStyle(fontSize: 12, color: Colors.red)),
              ],
            ),
          );
          ...
          return Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(widget.prType, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 15)),
                const SizedBox(height: 8.0),
                const Text('No products available', style: TextStyle(fontSize: 12)),
              ],
            ),
          );
        } else {
